...
import statrter2 from "../assets/starterImg/starter2.png"; 
import statrter3 from "../assets/starterImg/starter3.png"; 
    ...
    return(
        ...
        <Container>
            ...
            <Row >
                ...
                <img alt="StarterImage" src={statrter1} width={"100%"} style={{padding:"10px"}}/>
            ...
            <p style={{color:"red"}}>$3.5 </p> 
              ...
              <div style={{margin:"0.5px"}} className="starterCol">
              <img alt="StarterImage" src={statrter2} width={"100%"} style={{padding:"10px"}}/>
            ...
            <p style={{color:"red"}}>$7.95</p>
              ...
              <div style={{margin:"0.5px"}} className="starterCol">
              <img alt="StarterImage" src={statrter3} width={"100%"} style={{padding:"10px"}}/>
              <h4 style={{paddingTop:"30px"}}>
              Magnam Tiste
              </h4>
              <p>
            ...
            <Col md={12} lg={4}  xs={12}  onClick={()=>handleShow(3)}>
                <div style={{margin:"0.5px"}} className="starterCol">
                <img alt="StarterImage" src={statrter4} width={"100%"} style={{padding:"10px"}}/>
                <h4 style={{paddingTop:"30px"}}>
                 Magnam Tiste
                </h4>
            <p>
            ...
            <p style={{color:"red"}}>$4.39 </p>                    
              ...
              <div style={{margin:"3px"}} className="starterCol">
              <img alt="StarterImage" src={statrter5} width={"100%"} style={{padding:"10px"}}/>
                <h4 style={{paddingTop:"30px"}}>Magnam Tiste</h4>
            <p>
            Lorem, deren, trataro, filede, nerad
            </p>
            <p style={{color:"red"}}>$5.95</p>
              ...
              <div style={{margin:"0.5px"}} className="starterCol">
              <img alt="StarterImage" src={statrter6} width={"100%"} style={{padding:"10px"}}/>
              <h4 style={{paddingTop:"30px"}}>
              Magnam Tiste
              </h4>
              <p>
